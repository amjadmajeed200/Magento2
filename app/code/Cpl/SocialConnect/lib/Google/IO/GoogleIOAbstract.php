...
use Cpl\SocialConnect\lib\Google\Http\CacheParser as Google_Http_CacheParser;
/*
...
abstract class GoogleIOAbstract
{
  ...
  {
    $this->client = $client;
    $timeout = $client->getClassConfig('Cpl\SocialConnect\lib\Google\IO\GoogleIOAbstract', 'request_timeout_seconds');
    if ($timeout > 0) {
