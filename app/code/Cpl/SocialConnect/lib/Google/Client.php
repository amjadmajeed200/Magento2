<?php
namespace Cpl\SocialConnect\lib\Google;
/*
...
use \Cpl\SocialConnect\lib\Google\Config as Google_Config;
use \Cpl\SocialConnect\lib\Google\Auth\GoogleAuthAbstract as Google_Auth_Abstract;
use \Cpl\SocialConnect\lib\Google\Auth\OAuth2 as Google_Auth_OAuth2;
use \Cpl\SocialConnect\lib\Google\IO\Curl as Google_IO_Curl;
use \Cpl\SocialConnect\lib\Google\IO\GoogleIOAbstract as Google_IO_Abstract;
use \Cpl\SocialConnect\lib\Google\Logger\GoogleLoggerAbstract as Google_Logger_Abstract;
use \Cpl\SocialConnect\lib\Google\Http\Request as Google_Http_Request;
use \Cpl\SocialConnect\lib\Google\Exception as Google_Exception;
  ...
  public function __construct($config = null)
  {
    ...
    if ($config->getIoClass() == Google_Config::USE_AUTO_IO_SELECTION) {
      if (function_exists('curl_version') && function_exists('curl_exec')
          && !$this->isAppEngine()) {
        $config->setIoClass("Cpl\SocialConnect\lib\Google\IO\Curl");
      } else {
