...
class MassDelete extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('Holidays has been deleted.'));
        } catch (Exception $e) {
            $this->messageManager->addErrorMessage(__('Something wrong when deleting Holidays. %1', $e->getMessage()));
        }
