        ...
        foreach ($collection->getItems() as $holiday) {
            try {
                ...
                $this->messageManager->addErrorMessage(
                    $e,
                    __('Something went wrong while updating status for %1.', $holiday->getName())
                );
            }
        }

        if ($holidayUpdated) {
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been updated.', $holidayUpdated));
        }
