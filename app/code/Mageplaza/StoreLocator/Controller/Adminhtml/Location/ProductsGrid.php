...
use Mageplaza\StoreLocator\Block\Adminhtml\Location\Edit\Tab\Renderer\ProductsGrid as RendererProductsGrid;
 ...
 */
class ProductsGrid extends Location
{
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        $html = $page->getLayout()
            ->createBlock(RendererProductsGrid::class)->toHtml();
