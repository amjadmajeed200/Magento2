...
class MassDelete extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('Locations has been deleted.'));
        } catch (Exception $e) {
            $this->messageManager->addErrorMessage(__('Something wrong when deleting Locations. %1', $e->getMessage()));
        }
